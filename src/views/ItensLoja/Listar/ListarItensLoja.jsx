...
import { ListarItensLoja } from "../../../services/api/itensLoja";
...
const headRows = [
  ...
  { id: "preco", numeric: true, disablePadding: false, label: "CPGold" },
  {
...
export default function EnhancedTable() {
  ...
  useEffect(() => {
    const getData = async () => {
      const response = await ListarItensLoja();
    ...
    <div className={classes.root}>
      ...
      <Paper className={classes.paper}>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={4}>
            <Link to={`/admin/cadastrar/item_loja`}>
                ...
                .map((dataItem, index) => {
                  ...
                  return (
                    <TableRow hover tabIndex={-1} key={dataItem._id}>
                      ...
                      <TableCell align="right">{dataItem.preco}</TableCell>
                      <TableCell align="right">
                        {dataItem.quantidadeDisponivel}
                      </TableCell>
                      <TableCell align="right">
                        {dataItem.quantidadeVendida}
                      </TableCell>
                      <TableCell>{dataItem.tempoDisponivel}</TableCell>
                      <TableCell>
                        <Chip
                          color={
                      ...
                      <TableCell>
                        <Link
                          to={`/admin/cadastrar/item_loja/${dataItem._id}`}
